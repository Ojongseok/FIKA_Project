...
public final class FragmentViewPagerBinding implements ViewBinding {
  ...
  private FragmentViewPagerBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView indicatorTv, @NonNull ViewPager2 viewPager) {
    this.rootView = rootView;
    this.indicatorTv = indicatorTv;
  ...
  public static FragmentViewPagerBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.indicator_tv;
      TextView indicatorTv = ViewBindings.findChildViewById(rootView, id);
      if (indicatorTv == null) {
        break missingId;
      }
      ...
      return new FragmentViewPagerBinding((ConstraintLayout) rootView, indicatorTv, viewPager);
    }
