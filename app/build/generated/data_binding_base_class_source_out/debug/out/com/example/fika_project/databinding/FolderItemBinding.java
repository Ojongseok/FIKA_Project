...
public final class FolderItemBinding implements ViewBinding {
  ...
  private FolderItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView folderNameTv) {
  ...
  public static FolderItemBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.folder_name_tv;
      TextView folderNameTv = ViewBindings.findChildViewById(rootView, id);
      if (folderNameTv == null) {
        break missingId;
      }

      return new FolderItemBinding((ConstraintLayout) rootView, folderNameTv);
    }
