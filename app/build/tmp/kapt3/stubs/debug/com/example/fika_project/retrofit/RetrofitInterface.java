...
public abstract interface RetrofitInterface {
    ...
    public abstract retrofit2.Call<com.example.fika_project.ui.main.mypage.myspot.MySpotResponse> loadMySpot(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Header(value = "Access-Token")
    java.lang.String token);
    
    @org.jetbrains.annotations.NotNull()
    @retrofit2.http.POST(value = "/course/scrap/{courseId}")
    public abstract retrofit2.Call<com.example.fika_project.ui.main.hold_and_scrap.LocationScrapResponse> postLocationScrap(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Header(value = "Access-Token")
    java.lang.String token, @retrofit2.http.Path(value = "courseId")
    int courseId);
    
    @org.jetbrains.annotations.NotNull()
    @retrofit2.http.POST(value = "/spot/scrap/{spotId}")
    public abstract retrofit2.Call<com.example.fika_project.ui.main.hold_and_scrap.LocationHoldResponse> postLocationHold(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Header(value = "Access-Token")
    java.lang.String token, @retrofit2.http.Path(value = "spotId")
    int spotId);
