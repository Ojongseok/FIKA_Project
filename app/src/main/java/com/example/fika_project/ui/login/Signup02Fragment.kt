...
import com.example.fika_project.databinding.FragmentSignup02Binding
...
class Signup02Fragment  : Fragment() {
    ...
    private fun initClickListener(){
        ...
        binding.signup02BackBtn.setOnClickListener{
        ...
        binding.signup02FinishBtn.setOnClickListener {
            lActivity.changeFragment(1)
        }
    }
